<x-admin.layout>
  ...
  <div class="grid grid-cols-1 gap-5 md:grid-cols-2 xl:grid-cols-3">
    ...
    <article class="shadow-md rounded-lg p-3 bg-white dark:bg-gray-800">
      ...
      <div class="flex justify-between font-accent font-medium text-sm leading-7">
        @if ( $clase->students_count<1 )
          <a href="{{ route('admin.classroom.edit', ['classroom'=>$clase->id]) }}" class="rounded-full shadow-md border-2 py-2 xl:py-0 px-3 border-gray-500 text-gray-700 dark:text-gray-300 ">Editar</a>
        @endif
        <a href="{{ route('admin.classroom.assignStudents', $clase->id) }}" class="rounded-full shadow-md border-2 py-2 xl:py-0 px-3 border-gray-500 text-gray-700 dark:text-gray-300">Asignar estudiantes</a>
      </div>
    </article>
    @endforeach
  </div>
