    ...
    public function subscriptionCheckoutSession(Request $request)
    {
        ...
        try {
            ...
            $checkoutSession = \Stripe\Checkout\Session::create([
                ...
                'mode' => 'subscription',
                'success_url' => route('student.subscriptions.stripe.success') . '?session_id={checkoutSession_ID}',
